...
## Features
- **Velocity**: Calibrated using in-game entity telemetry (`0.0413265304548704` blocks/boat-tick).
...
- **Teleport Command Generator**: Copy `/tp @p X ~ Z` directly into Minecraft.
